...
export const NAV_ITEMS: NavItem[] = [
  ...
  { label: 'Escalas de Trabalho', href: '/escalas',          icon: 'CalendarDays', group: 'Departamento Pessoal', roles: ['adm_total', 'rh', 'gestor'] },
  ...
  { label: 'ASO (Exames Médicos)',href: '/aso',              icon: 'ClipboardPlus', group: 'Departamento Pessoal', roles: ['adm_total', 'rh'] },
  { label: 'Atestados',          href: '/atestados',        icon: 'Stethoscope',  group: 'Departamento Pessoal', roles: ['adm_total', 'rh', 'gestor'] },
  { label: 'Histórico Funcional',href: '/historico-funcional', icon: 'History',  group: 'Departamento Pessoal', roles: ['adm_total', 'rh'] },

...
type CalcRow = {
  employee:    Employee
  months:      number     // meses trabalhados no ano (1-12)
  gross:       number     // salário bruto proporcional
  inss:        number
  irrf:        number
  net:         number
  installment: number     // valor da parcela (1ª ou 2ª)
}
    ...
    <div className="space-y-6 p-1">
      ...
      <div className="bg-amber-50 border border-amber-200 rounded-xl p-4 text-sm text-amber-800">
        ...
        <ul className="space-y-1 text-xs">
          ...
          <li>• Tabelas INSS e IRRF 2024 aplicadas</li>
        </ul>
      </div>
    </div>
  )
